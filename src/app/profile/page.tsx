...
export default function Page() {
  return (
    <main className="mx-auto min-h-screen max-w-md px-5 py-8">
      ...
      <h1 className="mt-5 text-3xl font-bold">Профиль пары</h1>
      <p className="mt-3 leading-7 text-[var(--muted)]">Данные партнёров, важные даты, настройки приватности и управление аккаунтом.</p>
